  ...
  <header>
    ...
    <!-- <div class="row">
          <div class="container clearfix header-top">
                      <div id="logo">
              <a href="index.php"><img src="../assets/images/logo.png" alt="Paripex - Indian Journal Of Research" title="Paripex - Indian Journal Of Research" width="50px" height="50px"></a>
              <span style="font-size: 16px;">International Journal</span>             </div>
            
            <div class="logo-text">
              <h2><img src="images/ijar-text.png" alt="Paripex - Indian Journal Of Research" title="Paripex - Indian Journal Of Research"></h2>
