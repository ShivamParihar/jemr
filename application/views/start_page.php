      ...
      <div class="navbar navbar-static-top">
        <div class="navbar-inner">
          <div class="container">
            <!-- logo -->
            <div class="logo">
              <a href="index.html"><images src="../assets/images/logo.png" alt="" /></a>
            </div>
            <!-- end logo -->
        ...
        <div class="row">
          <div class="span12">
            ...
            <div id="mainslider" class="flexslider">
              <ul class="slides">
                <li data-thumb="../assets/images/slides/flexslider/images1.jpg">
                  <images src="../assets/images/slides/flexslider/images1.jpg" alt="" />
                  <div class="flex-caption primary">
                    <h2>Bootstrap</h2>
                    <p>Lorem ipsum dolor sit amet vix ceteros noluisse intellegat</p>
                  </div>
                </li>
                <li data-thumb="../assets/images/slides/flexslider/images2.jpg">
                  <images src="../assets/images/slides/flexslider/images2.jpg" alt="" />
                  
                </li>
                <li data-thumb="../assets/images/slides/flexslider/images3.jpg">
                  <images src="../assets/images/slides/flexslider/images3.jpg" alt="" />
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="span3 features e_pulse">
            <images src="../assets/images/dummies/images1.jpg" alt="" />
            <div class="box">
              <div class="divcenter">
          ...
          <div class="span3 features e_pulse">
            <images src="../assets/images/dummies/images2.jpg" alt="" />
            <div class="box">
              <div class="divcenter">
          ...
          <div class="span3 features e_pulse">
            <images src="../assets/images/dummies/images3.jpg" alt="" />
            <div class="box">
              <div class="divcenter">
          ...
          <div class="span3 features e_pulse">
            <images src="../assets/images/dummies/images4.jpg" alt="" />
            <div class="box">
              <div class="divcenter">
                ...
                <div id="latest-work" class="carousel btleft">
                  <div class="carousel-wrapper">
                    <ul class="da-thumbs">
                      ...
                      <li>
                        <images src="../assets/images/dummies/work1.jpg" alt="" />
                        <article class="da-animate da-slideFromRight">
                          <a class="zoom" data-pretty="prettyPhoto" href="../assets/images/dummies/big1.jpg">
                      ...
                      <li>
                        <images src="../assets/images/dummies/work2.jpg" alt="" />
                        <article class="da-animate da-slideFromRight">
                          <a class="zoom" data-pretty="prettyPhoto" href="../assets/images/dummies/big1.jpg">
														<i class="icon-zoom-in icon-rounded icon-48 active"></i>
													</a>
                      ...
                      <li>
                        <images src="../assets/images/dummies/work3.jpg" alt="" />
                        <article class="da-animate da-slideFromRight">
                          <a class="zoom" data-pretty="prettyPhoto" href="../assets/images/dummies/big1.jpg">
														<i class="icon-zoom-in icon-rounded icon-48 active"></i>
													</a>
                      ...
                      <li>
                        <images src="../assets/images/dummies/work4.jpg" alt="" />
                        <article class="da-animate da-slideFromRight">
                          <a class="zoom" data-pretty="prettyPhoto" href="../assets/images/dummies/big1.jpg">
														<i class="icon-zoom-in icon-rounded icon-48 active"></i>
													</a>
                      ...
                      <li>
                        <images src="../assets/images/dummies/work5.jpg" alt="" />
                        <article class="da-animate da-slideFromRight">
                          <a class="zoom" data-pretty="prettyPhoto" href="../assets/images/dummies/big1.jpg">
														<i class="icon-zoom-in icon-rounded icon-48 active"></i>
													</a>
                      ...
                      <li>
                        <images src="../assets/images/dummies/work6.jpg" alt="" />
                        <article class="da-animate da-slideFromRight">
                          <a class="zoom" data-pretty="prettyPhoto" href="../assets/images/dummies/big1.jpg">
														<i class="icon-zoom-in icon-rounded icon-48 active"></i>
													</a>
